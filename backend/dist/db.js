...
exports.syntheticPatients = exports.userStore = void 0;
exports.findUserByEmail = findUserByEmail;
exports.findUserById = findUserById;
exports.saveUser = saveUser;
exports.userStore = new Map();
function findUserByEmail(email) {
    return Array.from(exports.userStore.values()).find(u => u.email.toLowerCase() === email.toLowerCase());
}
function findUserById(id) {
    return exports.userStore.get(id);
}
function saveUser(user) {
    exports.userStore.set(user.id, user);
}
exports.syntheticPatients = {
    'P001': {
        id: 'P001',
        name: 'Rajesh Kumar',
        age: 62,
